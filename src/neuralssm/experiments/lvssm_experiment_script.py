...
for i in range(num_reps):
    ...
    lvssm = SPN(state_dim, num_reactions, emission_dim, emission_function, input_dim)
    ...
    states, emissions = lvssm.simulate(subkey, true_param, num_timesteps)
    ...
    test_model = SPN(state_dim, num_reactions, emission_dim, emission_function, input_dim)
