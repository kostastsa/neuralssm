...
def setup(state_dim, emission_dim, input_dim, target_vars, dt_obs=None):
    ...
    init_vals = _init_vals(emission_dim, population_size)
    param_dists = _param_dists(emission_dim, num_reactions, population_size)
    ...
    out = {}
    out['ssm'] = SPN(3, num_reactions, emission_dim, emission_dist, 0, dt_obs)
    out['inputs'] = None
    out['props'] = props
    out['exp_info'] = {
        'sim' : 'lgssm',
...
def get_param_info():
    ...
    import simulators.sirssm_params as param_info
